...
res_list = ['Rudy\'s "Country Store" and Bar-B-Q', 'Chompie\'s',
       'Firebirds Wood Fired Grill', 'New India Gate', 'Benihana',
       'Espos Mexican Food', 'The Cheesecake Factory', 'Abuelo\'s',
       'Tott\'s Asian Diner','Roy\'s Restaurant']


# 파일에 추가해서 쓰는거니까 새로 돌릴 때 기존 파일 삭제해야함
with open('C:\\Users\\CSE_125-2\\Desktop\\yelp_data\\bus_chandler.json', 'a', -1, encoding='UTF-8') as mf:
            ...
            if lineobj["postal_code"]== '85226':
                for name in res_list:
                    if lineobj['name'] == name:
                        ...
                        if name == 'Rudy\'s "Country Store" and Bar-B-Q':
                            file_data["name"] = "Rudy\'s Country Store and Bar-B-Q"
                        else:
